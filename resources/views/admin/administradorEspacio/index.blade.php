...
@section('content_header')
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h1 class="m-0">LISTADO DE ADMINISTRADORES DE ESPACIO</h1>
            </div>
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    <li class="breadcrumb-item"><a href="{{ url('/admin') }}">Inicio</a></li>
                    <li class="breadcrumb-item active">Administradores de espacio</li>
                </ol>
            </div>
        </div>
    </div>
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="alert alert-info">
                ...
                <em>ADMINISTRADOR DE ESPACIOS</em>.
            </div>

            <div class="card card-outline card-navy">
                <div class="card-header" style="background-color: #CCF3EA;">
                    <h3 class="card-title"><b>Administradores de Espacio Registrados</b></h3>
                </div>
                            ...
                            <tbody>
                                @forelse ($administradores as $administrador)
                                    <tr>
                                        ...
                                        <td>{{ $administrador->user->nombres }}</td>
                                        <td>{{ $administrador->user->apellidos }}</td>
                                        <td>{{ $administrador->user->celular }}</td>
                                        <td>{{ $administrador->turno ?? 'No asignado' }}</td>
                                        <td class="text-center">
                                            <a href="{{ route('admin.administradorEspacio.show', $administrador->id) }}"
                                               class="btn-icon-circle btn-view mr-1" title="Ver detalles">
                                                <i class="fas fa-eye"></i>
                                            </a>
                                            <a href="{{ route('admin.administradorEspacio.edit', $administrador->id) }}"
                                               class="btn-icon-circle btn-edit mr-1" title="Editar turno o descripcion">
