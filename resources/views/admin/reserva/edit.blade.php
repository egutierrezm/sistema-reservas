                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group mb-3">
                                    ...
                                    <input type="date" class="form-control" name="fechaReserva" id="fechaReserva"
                                        value="{{ old('fechaReserva', $reserva->fechaReserva) }}" required>
                                </div>
                                @error('fechaReserva')
                                    <small style="color:red">{{ $message }}</small>
                                @enderror
...
$(function () {
    ...
    // Mostrar imagen y disciplinas de la cancha
        ...
        $.ajax({
            ...
            success: function(bloques) {
                ...
                bloques.forEach(b => {
                    ...
                    const horaInicioReserva = reserva.horaInicio.slice(0,5);
                    const horaFinReserva = reserva.horaFin.slice(0,5);

                    if (horaInicioReserva === b.inicio && horaFinReserva === b.fin) {
                        boton.removeClass('btn-success').addClass('btn-primary');
                        boton.prop('disabled', false);
                    }

                    if (!b.ocupado || (horaInicioReserva === b.inicio && horaFinReserva === b.fin)) {
