...
@section('content_header')
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h1 class="m-0">Editar Asignación de Controlador a Cancha</h1>
            </div>
            <div class="col-sm-6">
    ...
    <div class="col-md-8">
        <div class="card card-success">
            <div class="card-header">
                <h3 class="card-title">Complete los campos para actualizar la asignación</h3>
            </div>
            <div class="card-body">
                <form action="{{ route('admin.asignacion.update', $asignacion->id) }}" method="POST">
                    @csrf
                    @method('PUT')
                                ...
                                <div class="input-group mb-3">
                                    ...
                                    <select name="espacio_id" id="espacio_id" class="form-control" required>
                                        ...
                                        @foreach($espacios as $espacio)
                                            <option value="{{ $espacio->id }}" {{ $espacio->id == $espacioSeleccionadoId ? 'selected' : '' }}>
                                                {{ $espacio->nombre }}
                                            </option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="input-group mb-3">
                                    ...
                                    <select name="cancha_id" id="cancha_id" class="form-control" required>
                                        ...
                                        @foreach($canchas as $cancha)
                                            <option value="{{ $cancha->id }}" {{ $cancha->id == $asignacion->cancha_id ? 'selected' : '' }}>
                                                {{ $cancha->nombre }}
                                            </option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="input-group mb-3">
                                    ...
                                    <select name="controlador_id" id="controlador_id" class="form-control" required>
                                        ...
                                        @foreach($controladores as $controlador)
                                            <option value="{{ $controlador->id }}" {{ $controlador->id == $asignacion->controlador_id ? 'selected' : '' }}>
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group mb-3">
                                    ...
                                    <input type="date" name="fechaAsignacion" id="fechaAsignacion" class="form-control"
                                        value="{{ old('fechaAsignacion', \Carbon\Carbon::parse($asignacion->fechaAsignacion)->format('Y-m-d')) }}" required>
                                </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group mb-3">
                                    ...
                                    <select name="turnoAsignado" id="turnoAsignado" class="form-control" required>
                                        ...
                                        <option value="Mañana" {{ $asignacion->turnoAsignado == 'Mañana' ? 'selected' : '' }}>Mañana</option>
                                        <option value="Tarde" {{ $asignacion->turnoAsignado == 'Tarde' ? 'selected' : '' }}>Tarde</option>
                                        <option value="Noche" {{ $asignacion->turnoAsignado == 'Noche' ? 'selected' : '' }}>Noche</option>
                                    </select>
                                </div>
                                @error('turnoAsignado')
                                    <small style="color: red">{{ $message }}</small>
